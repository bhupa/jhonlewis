                    ...
                    <div class="col-lg-12">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li aria-current="page" class="breadcrumb-item active">Appointment Form</li>
                            </ol>
                        </nav>
                    </div>
...
{{--                                            <input class="form-control enchilada" type="text"  name="date" data-placeholder="Start Date" placeholder="2018-03-05" id="datepicker" value="{{date('d-m-Y', strtotime($schedule->date))}}">--}}
                            ...
                            <div class="box-footer d-flex justify-content-between">
                                ...
                                @else
                                    <button type="button" id="appointment-url" data-type="{{route('appointment.store')}}" class="btn btn-primary">Book Appointment</button>
                                @endif
                            </div>
                            {{--                        </form>--}}
                            {{Form::close()}}
