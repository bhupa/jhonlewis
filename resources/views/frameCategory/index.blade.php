                    ...
                    <div class="col-lg-12">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li aria-current="page" class="breadcrumb-item active">Frame Category</li>
                                <li aria-current="page" class="breadcrumb-item active">{{$frameCategory->title}}</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-3">
