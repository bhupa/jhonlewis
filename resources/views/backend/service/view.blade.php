                        ...
                        <table class="table text-center" id="table">
                            ...
                            @foreach($services as $key=>$item)
                                <tr id="item-{{$item->id}}">
                                    ...
                                    <td>{{str_limit($item->short_description,'150','....')}}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('services.edit', $item->slug)}}" class="edit-modal btn btn-info btn-circle btn-sm"
                                           data-info="">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        {{-- @endif --}}
                                        {{-- @if(auth()->user()->can('delete-banner')) --}}
                                        <a href="javascript:void(0)" class="delete-services btn btn-danger btn-circle btn-sm"
                                           data-type="{{$item->id}}">
...
@section('js_script')
            <script>
                $(document).ready( function () {
                    ...
                    $('#table').on('click','.delete-services',function(event){
                        event.preventDefault();
                        $object = $(this);
                        var id  = $(this).attr('data-type');
                        var url = baseUrl+"/services/"+id;
                        swal({
                            title: 'Are you sure?',
