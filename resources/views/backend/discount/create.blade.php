                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('discounts.index')}}"> View Discount</a></li>
                ...
                <div class="row justify-content-center">
                    <div class="col-8 ">
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            {!! Form::open(['route'=>'discounts.store','class'=>'needs-validation"','enctype'=>   "multipart/form-data"])!!}
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="percentage" placeholder="Enter Percentage" value="{{old('percentage')}}">
