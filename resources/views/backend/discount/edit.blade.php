                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('discounts.create')}}"> Add Discount</a></li>
                ...
                <div class="row justify-content-center">
                    <div class="col-8 ">
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            {!! Form::model($discounts,['route'=>['discounts.update',$discounts->id],'class'=>'needs-validation','method'=>'PUT','enctype'=>   "multipart/form-data"])!!}

                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Title</label>
                                    <input type="text" class="form-control" name="title" placeholder="Enter Title" value="{{$discounts->title}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="percentage" placeholder="Enter disocunt" value="{{$discounts->percentage}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="cover edit-cover" >
                                        <a href="#">
                                            @if(file_exists('storage/'.$discounts->image) && $discounts->image != '')
                                                <img id="edit-logo-output"
                                                     src="{{asset('storage/'.$discounts->image)}}"
                                ...
                                <div class="form-group">
                                    ...
                                    {{Form::textarea('short_description',$discounts->short_description,['class'=>'form-control','id'=>'short_description'])}}
