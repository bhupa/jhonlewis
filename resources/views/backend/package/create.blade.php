                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('packages.index')}}"> View Package</a></li>
                ...
                <div class="row justify-content-center">
                    <div class="col-8 ">
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            {!! Form::open(['route'=>'packages.store','class'=>'needs-validation"','enctype'=>   "multipart/form-data"])!!}
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control enchilada" type="date"  name="start_date" data-placeholder="Start Date" placeholder="2018-03-05" id="datepicker" value="{{ old('start_date') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control enchilada" type="date"  name="end_date" data-placeholder="End Date" placeholder="2018-03-05" id="datepicker" value="{{ old('end_date') }}">
