                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('glasses.create')}}"> Add Glasses </a></li>
                            ...
                            @foreach($glasses as $key=>$item)
                                <tr id="item-{{$item->id}}">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('glasses.edit', $item->slug)}}" class="edit-modal btn btn-info btn-circle btn-sm"
                                           data-info="">
                    ...
                    $("#table").on("click", "#change-status", function () {
                        ...
                        swal({
                            ...
                            if (result.value) {
                                $.ajax({
                                    type: "POST",
                                    url: "{{ route('glasses.change-status') }}",
                                    data: {
                                        'id': id,
                                    },
                                    headers: {
                                    ...
                                    success: function (response) {
                                        ...
                                        if (response.glasses.is_active == 1) {
