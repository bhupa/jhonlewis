                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('sunglasses.create')}}"> Add Sunglasses </a></li>
                ...
                <div class="single-table">
                    <div class="table-responsive">
                        <table class="table text-center" id="table">
                            ...
                            @foreach($sunglasses as $key=>$item)
                                <tr id="item-{{$item->id}}">
                                    <td>{{$key+1}}</td>
                                    <td>{{$item->name}}</td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('sunglasses.edit', $item->slug)}}" class="edit-modal btn btn-info btn-circle btn-sm"
                                           data-info="">
                    ...
                    $("#table").on("click", "#change-status", function () {
                        ...
                        swal({
                            ...
                            if (result.value) {
                                $.ajax({
                                    type: "POST",
                                    url: "{{ route('sunglasses.change-status') }}",
                                    data: {
                                        'id': id,
                                    },
                                    headers: {
                                    ...
                                    success: function (response) {
                                        ...
                                        if (response.sunglasses.is_active == 1) {
