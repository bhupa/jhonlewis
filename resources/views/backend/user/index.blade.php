                        ...
                        <table class="table text-center" id="table">
                            ...
                            @foreach($users as $key=>$item)
                                <tr id="item-{{$item->id}}">
                                    ...
                                    <td>
{{--                                        <a href="{{route('users.edit', $item->id)}}" class="edit-modal btn btn-info btn-circle btn-sm"--}}
{{--                                           data-info="">--}}
{{--                                            <i class="fas fa-edit"></i>--}}
{{--                                        </a>--}}
                                        {{-- @if(auth()->user()->can('edit-banner')) --}}
{{--                                        <a href="javascript:void(0)" id="reply-user-email" class="edit-modal btn btn-success btn-circle btn-sm"--}}
{{--                                           data-type="{{$item->id}}">--}}
{{--                                            <i class="fas fa-envelope"></i>--}}
{{--                                        </a>--}}
                                        {{-- @endif --}}
                                        {{-- @if(auth()->user()->can('delete-banner')) --}}
                                        <a href="javascript:void(0)" class="delete-users btn btn-danger btn-circle btn-sm"
                                           data-type="{{$item->id}}">
...
@section('js_script')
    <script>
        $(document).ready( function () {
            ...
            $('#table').on('click','.delete-users',function(event){
