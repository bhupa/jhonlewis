@extends('backend.app')
@section('title','Frame-Category-Lists')
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('frame-categories.create')}}"> Add Frame Category </a></li>
                            ...
                            @foreach($frames as $key=>$item)
                                <tr id="item-{{$item->id}}">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('frame-categories.edit', $item->slug)}}" class="edit-modal btn btn-info btn-circle btn-sm"
                                           data-info="">
            ...
            <script>
                $(document).ready( function () {
                    ...
                    $('#table').on('click','.delete-content',function(event){
                        ...
                        var url = baseUrl+"/frame-categories/"+id;
                        swal({
                            title: 'Are you sure?',
                    ...
                    $("#table").on("click", "#change-status", function () {
                        ...
                        swal({
                            ...
                            if (result.value) {
                                $.ajax({
                                    type: "POST",
                                    url: "{{ route('frame-categories.change-status') }}",
                                    data: {
                                        'id': id,
                                    },
                                    headers: {
                                    ...
                                    success: function (response) {
                                        ...
                                        if (response.frameCategories.is_active == 1) {
