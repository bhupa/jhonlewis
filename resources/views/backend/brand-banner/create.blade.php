@extends('backend.app')
@section('title','Add-Brand-Banner')
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('brand-banners.index')}}"> View Brand-Banner Lists</a></li>
                    ...
                    <div class="col-8 ">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Add Brand-Banner<</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            {!! Form::open(['route'=>'brand-banners.store','class'=>'needs-validation"','enctype'=>   "multipart/form-data"])!!}
