                        ...
                        <div id="productMain" class="row">
                            <div class="col-md-6">
                                <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                                    <div class="item"> <img src="https://d19m59y37dris4.cloudfront.net/obaju/2-1-1/img/detailbig1.jpg" alt="" class="img-fluid"></div>
                                    <div class="item"> <img src="https://d19m59y37dris4.cloudfront.net/obaju/2-1-1/img/detailbig2.jpg" alt="" class="img-fluid"></div>
                                    <div class="item"> <img src="https://d19m59y37dris4.cloudfront.net/obaju/2-1-1/img/detailbig3.jpg" alt="" class="img-fluid"></div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="box">
                                    ...
                                    <p class="text-center buttons"><a href="{{route('cart.index')}}" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> Add to cart</a><a href="{{route('cart.index')}}" class="btn btn-outline-primary"><i class="fa fa-heart"></i> Add to wishlist</a></p>
                                </div>
                                <div data-slider-id="1" class="owl-thumbs">
                                    <button class="owl-thumb-item"><img src="https://d19m59y37dris4.cloudfront.net/obaju/2-1-1/img/detailsquare.jpg" alt="" class="img-fluid"></button>
                                    <button class="owl-thumb-item"><img src="https://d19m59y37dris4.cloudfront.net/obaju/2-1-1/img/detailsquare2.jpg" alt="" class="img-fluid"></button>
                                    <button class="owl-thumb-item"><img src="https://d19m59y37dris4.cloudfront.net/obaju/2-1-1/img/detailsquare3.jpg" alt="" class="img-fluid"></button>
                                </div>
                            </div>
                        </div>
